...
namespace qmapcontrol
{
     ...
     */
    class QMAPCONTROL_EXPORT Vector : public Point
    {
    public:
        //!
        /*!
         ...
         */
        Vector(qreal x, qreal y, int sideLength, qreal heading, QString name = QString(), Alignment alignment = Middle, QPen* pen=0);
        virtual ~Vector();
